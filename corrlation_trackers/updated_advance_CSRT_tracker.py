...
def generate_sliding_windows(frame_width, frame_height, window_size=50, step_size=10):
...
def re_identification_thread():
    ...
    while True:
        ...
        if orb_active and initial_descriptors is not None:
            ...
            sliding_window_bboxes = generate_sliding_windows( DESIRED_WIDTH, DESIRED_HEIGHT)
            ...
            if found_bbox:
                ...
                tracker = cv2.TrackerCSRT_create()  # Changed to CSRT tracker
...
def video_feed_thread():
    ...
    while True:
        ...
        if ret:
            ...
            cv2.putText(frame, "CSRT Tracker", (100, 70), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2, cv2.LINE_AA)
